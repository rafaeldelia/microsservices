package br.com.arphoenix.microsservices.service;
...
import br.com.arphoenix.microsservices.model.Person;
...
public class PersonService {
	...
	public Person findById(Long id) {
		return new Person(counter.incrementAndGet(), "Rafael", "Rua Coronel Paulo Malta Rezende", "apto 810 bloco 02");
	}
